...
def test_coverage_reports_all_layers_and_union(cov):
    ...
    assert cov["edges_by_origin"].get("lifecycle") == 68     # executability lifecycle layer
    ...
    assert cov["relations_lifecycle"] == 60   # executable sacrifice->termination traversals
