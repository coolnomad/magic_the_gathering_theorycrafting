# Effect-semantics — structured effects (Phase 3 object families + Phase 4a participant families)
...
| `EXCHANGES_CONTROL_OF` | 150 |  | `UNTAP` | 5 |
| `SETS_BASE_PT` | 115 |  | `SET_BASE_PT` | 4 |
| `CAN_FIGHT` | 112 |  | `CHANGE_TYPE` | 3 |
| `PREVENTS_DAMAGE_FROM` | 112 |  | `TAP` | 2 |
|  |  |  | `FIGHT` | 1 |
|  |  |  | `CONTROL_CHANGE` | 1 |
|  |  |  | `PREVENT_DAMAGE` | 1 |
