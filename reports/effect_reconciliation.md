# Effect-semantics — (clause_id, family) reconciliation (Phase 3 + Phase 4a draw/life + 4b discard/mill + 4c sacrifice + 4d search + 4e return)
...
- (clause, family) pairs: **337**  · extracted: **227**  · deferred/nonexecutable: **4**  · unresolved: **0**
...
| blink (exile-and-return — coupled to the deferred exile/movement slice) | 3 |
