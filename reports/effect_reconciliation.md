# Effect-semantics — (clause_id, family) reconciliation (Phase 3 + Phase 4a draw/life + Phase 4b discard/mill)
...
- (clause, family) pairs: **275**  · extracted: **185**  · deferred/nonexecutable: **4**  · unresolved: **0**

| disposition | (clause,family) |
|---|---:|
| extracted | 185 |
| reminder_text (family appears only in reminder text) | 28 |
